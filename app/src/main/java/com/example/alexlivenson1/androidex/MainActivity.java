package com.example.alexlivenson1.androidex;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        // 1. Call super class to make sure activity ready to go
        super.onCreate(savedInstanceState);

        // 2. Specify the layout for this activity is provided by the layout you created before
        setContentView(R.layout.activity_main);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        // 3. Populate values of the three members you created before for the views (id same as in XML layout)
        ...
        // 4. Simple class encapsulates functionality you'd like to perform when button pressed
